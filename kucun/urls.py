...
urlpatterns = [
    ...
    url(r'^api/delete_order_record/$', kucun.views.delete_order_record,name="delete_order_record"),
    ...
    url(r'^api/change_order_arrears/$',kucun.views.api_change_order_arrears,name="api_change_order_arrears"),
    #
